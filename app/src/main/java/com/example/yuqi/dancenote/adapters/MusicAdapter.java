...
public class MusicAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        //赋值 准确的是绑定赋值的中介
        viewHolder.titleTv.setText(musicList.get(position).title);
        viewHolder.artistTv.setText(musicList.get(position).artist + "-" + musicList.get(position).album);
        viewHolder.albumImgv.setImageBitmap(musicList.get(position).albumBip);
